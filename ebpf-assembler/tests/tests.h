...
static struct bpf_insn test104[TEST104_SIZE] = {
  ...
  BPF_LDX_MEM(BPF_SIZE_8, BPF_REG_0, BPF_REG_1, 8),
  BPF_LDX_MEM(BPF_SIZE_16, BPF_REG_0, BPF_REG_1, 8),
  BPF_LDX_MEM(BPF_SIZE_32, BPF_REG_0, BPF_REG_1, 8),
  BPF_LDX_MEM(64, BPF_REG_0, BPF_REG_1, 8),
  BPF_ST_MEM(BPF_SIZE_8, BPF_REG_0, 8, 8192),
  BPF_ST_MEM(BPF_SIZE_16, BPF_REG_0, 8, 8192),
  BPF_ST_MEM(BPF_SIZE_32, BPF_REG_0, 8, 8192),
  BPF_ST_MEM(64, BPF_REG_0, 8, 8192),
  BPF_STX_MEM(BPF_SIZE_8, BPF_REG_0, BPF_REG_1, 8),
  BPF_STX_MEM(BPF_SIZE_16, BPF_REG_0, BPF_REG_1, 8),
  BPF_STX_MEM(BPF_SIZE_32, BPF_REG_0, BPF_REG_1, 8),
...
static struct bpf_insn test109[TEST109_SIZE] = {
  ...
  BPF_LDX_MEM(BPF_SIZE_32, BPF_REG_0, BPF_REG_1, 8),
  BPF_LDX_MEM(64, BPF_REG_0, BPF_REG_1, 8),
  BPF_ST_MEM(BPF_SIZE_8, BPF_REG_0, 8, 128),
  BPF_ST_MEM(BPF_SIZE_16, BPF_REG_0, 8, 128),
  BPF_ST_MEM(BPF_SIZE_32, BPF_REG_0, 8, 128),
