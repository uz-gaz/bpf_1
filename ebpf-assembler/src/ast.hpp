...
static const InsL instructions[] =
  {{"add", add},  {"sub", sub}, {"mul",  mul}, {"div", div_}, {"or",  or_},
   ...
   {"xor", xor_}, {"mov", mov}, {"arsh", arsh}, {"sdiv", sdiv}, {"smod", smod},
   {"movsx8", movsx8}, {"movsx16", movsx16}, {"movsx32", movsx32},
   ...
   {"arsh32", arsh32}, {"mov32sx8", mov32sx8}, {"mov32sx16", mov32sx16},
   {"sdiv32", sdiv32}, {"smod32", smod32},
   ...
   {"ldxs8",  ldxs8},  {"ldxs16",  ldxs16},  {"ldxs32",  ldxs32},
   ...
   {"jal", jal}, {"jeq32",  jeq32},  {"jgt32",  jgt32},  {"jge32",  jge32},
