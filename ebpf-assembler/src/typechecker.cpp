    ...
    MATCH (type(i)) {
      case Instruction:
        MATCH (isa(i)) {
          ...
          case sdiv: case smod: case sdiv32: case smod32:
          case movsx8: case movsx16: case movsx32: case mov32sx8: case mov32sx16:
          ...
          /* ldabs8, ldabs16, ldabs32, ldabs64,
             ja, call, rel */
          case ldabs8: case ldabs16: case ldabs32: case ldabs64:
          case ja: case jal:
          case call:   case rel:
          ...
          case ldxs8:    case ldxs16:   case ldxs32:
            if (optype(FST, i) != Register)
              unexpected(FST, i, "REG");
